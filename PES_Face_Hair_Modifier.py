import bpy, os, shutil, struct, bpy.props, bpy_extras.io_utils, re
...
class PESModifier_PT_Main(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.alignment = 'CENTER'
        row.label(text="Version 1.0.1", icon='BLENDER')
