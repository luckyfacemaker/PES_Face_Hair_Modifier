...
import bpy
from .. import PES_Face_Hair_Modifier
...
def setShader(self, context):
	...
	material = PES_Face_Hair_Modifier.active_material(context)
	parameter = material.fmdl_material_parameters.clear()
	blenderMaterial = bpy.context.active_object.active_material
	PES_Face_Hair_Modifier.node_group()
	blenderMaterial.use_nodes = True
	if 'pes_alpha_clip_threshold' in blenderMaterial:
		del blenderMaterial['pes_alpha_clip_threshold']
